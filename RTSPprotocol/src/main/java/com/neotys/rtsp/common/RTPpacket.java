...
public class RTPpacket {
	//size of the RTP header:
	    ...
	    public String printheader()
	    {
	    	...
	    	output.append("[RTP-Header] \n");
	    	output.append("Version: " + Version +"\n");
	    	output.append(",Padding: " + Padding+"\n");
	    	output.append(", Extension: " + Extension +"\n");
	    	output.append(", CC: " + CC+"\n");
	        output.append(", Marker: " + Marker +"\n");
	    	output.append(", PayloadType: " + PayloadType+"\n");
	    	output.append(", SequenceNumber: " + SequenceNumber+"\n");
